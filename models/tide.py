"""TiDE — MLP encoder-decoder via neuralforecast."""
...
def build(
    ...
    """Build NeuralForecast with TiDE.
    ...
    return ModelSpec(name="TiDE", model_type="neural", forecaster=nf, needs_seed=True)
