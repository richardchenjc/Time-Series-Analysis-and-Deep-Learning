"""
Pipeline: TiDE across all 3 datasets (M4, M5, Traffic).

Usage:
    python pipelines/run_tide.py                # Full run
    python pipelines/run_tide.py --smoke-test   # Quick validation
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run TiDE on all datasets.")
