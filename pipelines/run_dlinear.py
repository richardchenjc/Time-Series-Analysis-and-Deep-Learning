"""
Pipeline: DLinear across all 3 datasets (M4, M5, Traffic).

Usage:
    python pipelines/run_dlinear.py                # Full run
    python pipelines/run_dlinear.py --smoke-test   # Quick validation
"""
...
from models.dlinear import build
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run DLinear on all datasets.")
